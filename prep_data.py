...
for lang in data['language'].unique():
    ...
    pk.dump(lang_train.to_dict(), open(data_dir + f"clean_{lang_code_map[lang]}_train.pk", "wb"))
    pk.dump(lang_test.to_dict(), open(data_dir + f"clean_{lang_code_map[lang]}_test.pk", "wb"))
    pk.dump(lang_dev.to_dict(), open(data_dir + f"clean_{lang_code_map[lang]}_dev.pk", "wb"))